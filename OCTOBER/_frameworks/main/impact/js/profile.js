var CProfile = function(guid,spotlightNumber,requestUri,isFreeSite) {
        ...
        $.ajax({
            ...
            success:function(data){
                if(data){
                    ...
                    alert('Your PDF is successfully uploaded!');
                    location.reload();
                } else{
    ...
    this.submit_education = function(event, info) {
        ...
        $('[name="education_level_id[]"]').each(function() {
            if($(this).val() == "") {
                err++;
                alertCustom('Please type Level of Education!',true,'Information incomplete');
                return false
            }
        });
        $('[name="degree_id[]"]').each(function() {
            if($(this).val() == "") {
                err++;
                alertCustom('Please type Degree!',true,'Information incomplete');
                return false
            }
        });
        $('[name="subject_title[]"]').each(function() {
            if($(this).val() == "") {
                err++;
                alertCustom('Please type Subject!',true,'Information incomplete');
                return false
            }
        });
