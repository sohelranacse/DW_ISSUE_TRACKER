<form id="frm_update_relatives" name="frm_update_relatives" method="POST" onsubmit="return Profile.submit_relatives(event, this)">
    ...
    <div class="formdiv">
        ...
        <div style="text-align: right;padding-right: 6px;padding-top: 10px;">
            <button class="btn small pink" style="padding: 0 20px;" value="<?php if($n) echo $n+1; else echo 2; ?>" id="ind" type="button" onclick="return Profile.add_more_relatives_field(this.value, myField)">Add more <i class="fa fa-plus"></i></button>
        </div>
