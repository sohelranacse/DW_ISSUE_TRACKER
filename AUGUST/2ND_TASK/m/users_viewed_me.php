...
$list->m_sql_from_add = " JOIN users_view AS v ON (u.user_id=v.user_from AND (v.user_to= {$user_id} OR v.user_to IN (SELECT user_id FROM user WHERE under_admin = {$user_id})))";
